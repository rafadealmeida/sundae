...
export function AddActivityModal({ isOpen, onClose }) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log('Adicionando atividade:', { nome: activityName, projeto: selectedProject, categoria: selectedCategory })
    setActivityName('')
    setSelectedProject('')
    setSelectedCategory('')
    onClose()
      ...
      <DialogContent className="sm:max-w-[425px]">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-2">
            <label htmlFor="activityName" className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">
              Nome da Atividade
            </label>
            <Input
              id="activityName"
